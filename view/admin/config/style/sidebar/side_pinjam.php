            ...
            <div class="sidebar">
              ...
              <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item">
                      <a href="?user=data_user" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="?mobil=data_mobil" class="nav-link">
                  ...
                  <li class="nav-item">
                      <a href="?pinjam=data_peminjaman" class="nav-link active">
                  ...
                  <li class="nav-item">
                      <a href="?pengembalian=data_pengembalian" class="nav-link">
                          <i class="nav-icon fas fa-hand-holding-water"></i>
                          <p>
                              Pengembalian Mobil
                          </p>
